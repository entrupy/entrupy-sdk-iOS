...
typedef SWIFT_ENUM_NAMED(NSInteger, EntrupyButtonBackgroundState, "EntrupyButtonBackgroundState", open) {
  ...
  EntrupyButtonBackgroundStateImageTooBright = 10,
  EntrupyButtonBackgroundStateImageTooDark = 11,
  EntrupyButtonBackgroundStatePhotoCaptured = 12,
};
...
///   </li>
///   <li>
///     modelPath: Local path to an already downloaded model
///   </li>
///   <li>
///     captureDevice: The AVCaptureDevice used for reading ISO during exposure analysis (optional)
///   </li>
///   <li>
///     completion: Callback to handle model loading results
///   </li>
/// </ul>
- (nonnull instancetype)initWithViewSize:(CGSize)viewSize regionType:(NSString * _Nonnull)regionType modelPath:(NSString * _Nullable)modelPath captureDevice:(AVCaptureDevice * _Nullable)captureDevice completion:(void (^ _Nullable)(BOOL, NSError * _Nullable))completion OBJC_DESIGNATED_INITIALIZER;
